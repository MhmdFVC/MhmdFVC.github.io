...
DONT_REMOVE_OBJECT south_roadblock Practice SCM - no roadblocks!*/
...
//CREATE_CAR_GENERATOR -1184.3601 -1312.6200 13.7274 64.6821 BUS -1 -1 0 0 0 0 10000 gen_car39 // Practice SCM - no bus pls
...
SWITCH_CAR_GENERATOR gen_car3 101*/ // Practice SCM - No oceanic plox
...
// *********Practice SCM - starting scripts for certain mission markers, additional tweaks********************************************
START_NEW_SCRIPT practice_mission_loop	// Practice selector area mission
START_NEW_SCRIPT baron_mission2_loop	// Phnom Penh
START_NEW_SCRIPT protect_mission2_loop	// Bar Brawl
START_NEW_SCRIPT counter_mission2_loop	// Hit the Courier
START_NEW_SCRIPT serg_mission2_loop		// Demolition Man
START_NEW_SCRIPT bankjob_mission2_loop	// The Shootist
START_NEW_SCRIPT lawyer_mission2_loop	// Back Alley Brawl
START_NEW_SCRIPT general_mission3_loop	// Guardian Angels
START_NEW_SCRIPT finale_mission1_loop	// Cap the Collector
START_NEW_SCRIPT printers_save_loop		// Printworks save marker

//START_NEW_SCRIPT protect_mission1_loop	// Shakedown; currently unused

icecream_asset_acquired = 1				// To fool CTC into letting the collectors stop there

VAR_INT practice_marker demoman_ip_remote_nades demoman_ip_psg
//ADD_SPHERE -1164.690063 -1308.872559 14.5 1.0 practice_marker
...
SET_PLAYER_NEVER_GETS_TIRED player1 TRUE // Infinite sprint
LOAD_MISSION_TEXT AMBULAE
PRINT_HELP A_COMP2 // "You will never get tired!"

// Create Mr. Vercetti clothes and set var for creation to 1 to enable processing in pickups.sc (i.e. actually changing clothes)
CREATE_CLOTHES_PICKUP -1168.763062 -1305.008911 14.809786 9 clothes_pickup8
clothes8_created = 1

flag_played_bank2_before = 1 // Allows skipping of Shootist gun range tutorial
CREATE_PICKUP_WITH_AMMO BOMB PICKUP_ON_STREET 4 -672.826111 1210.131592 11.106965 demoman_ip_remote_nades
CREATE_PICKUP_WITH_AMMO LASER PICKUP_ON_STREET 40 252.672272 -229.662201 10.901572 demoman_ip_psg
//////////////////////////////////////////////////////////////////////////////
