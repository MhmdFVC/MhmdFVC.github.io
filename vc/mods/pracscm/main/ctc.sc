...
// Mission start stuff
VAR_INT is_audio_in_use audio_1_flag audio_2_flag audio_3_flag audio_4_flag audio_5_flag
VAR_INT audio_6_flag audio_7_flag audio_8_flag audio_9_flag audio_10_flag audio_11_flag
VAR_INT audio_1_timeout audio_2_timeout audio_3_timeout audio_4_timeout audio_5_timeout
VAR_INT audio_6_timeout audio_7_timeout audio_8_timeout audio_9_timeout audio_10_timeout audio_11_timeout
VAR_INT cutscene_timer print_timer timer num_of_followers
...
REQUEST_MODEL PCJ600 // Practice SCM
...
// Practice SCM - setting traffic to 0 and displaying collector/sanchez HP, spawning a PCJ, giving M4, and setting weapon to sniper
SET_PED_DENSITY_MULTIPLIER 0.0
SET_CAR_DENSITY_MULTIPLIER 0.0

VAR_INT collector1_car_hp collector1_hp collector1_dude1_hp ctc_pcj
DISPLAY_NTH_ONSCREEN_COUNTER_WITH_STRING collector1_car_hp COUNTER_DISPLAY_NUMBER 1 HOTR_05
DISPLAY_NTH_ONSCREEN_COUNTER_WITH_STRING collector1_hp COUNTER_DISPLAY_NUMBER 2 HOTR_09
DISPLAY_NTH_ONSCREEN_COUNTER_WITH_STRING collector1_dude1_hp COUNTER_DISPLAY_NUMBER 3 HOTR_06

CREATE_CAR PCJ600 -1055.240723 -277.636414 11.338301 ctc_pcj
SET_CAR_HEADING ctc_pcj 0.0

GIVE_WEAPON_TO_PLAYER player1 WEAPONTYPE_M4 30
...
cap1_mission_loop:
	...
	// Practice SCM - setting HP of collectors and their bike
	IF NOT IS_CAR_DEAD collector1_car
		GET_CAR_HEALTH collector1_car collector1_car_hp
	ELSE
		collector1_car_hp = 0
	ENDIF

	IF NOT IS_CHAR_DEAD collector1
		GET_CHAR_HEALTH collector1 collector1_hp
	ELSE
		collector1_hp = 0
	ENDIF

	IF NOT IS_CHAR_DEAD collector1_dude1
		GET_CHAR_HEALTH collector1_dude1 collector1_dude1_hp
	ELSE
		collector1_hp = 0
	ENDIF
	///////////
	...
	ELSE
		...
		ELSE
			IF NOT collector1_goto_x = 999999999.0
				...
				// Practice SCM - clearing collectors HP
				CLEAR_ONSCREEN_COUNTER collector1_car_hp
				CLEAR_ONSCREEN_COUNTER collector1_hp
				CLEAR_ONSCREEN_COUNTER collector1_dude1_hp
			ENDIF
		ENDIF
	ENDIF
...
MARK_MODEL_AS_NO_LONGER_NEEDED PCJ600 // Practice SCM
