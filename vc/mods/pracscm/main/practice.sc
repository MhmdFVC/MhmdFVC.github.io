...
// Initializing vars
VAR_INT allow_movement_after_cleanup yesduping practice_spotlight htc_money phone bar_brawl_nades htc_vehicle

VAR_INT htc_cheetah htc_pcj pp86_maverick demoman_ip_rcheli bab_cs_infernus juice_end_pcj ga_admiral
VAR_INT snd_end_squalo bar_brawl_securicar ctc_sanchez
...
VAR_INT bab_cs_marker juice_end_marker ga_marker snd_end_marker bar_brawl_marker ctc_marker
...
// Giving player movement and providing weapons
...
// G-Spotlight cutscene package pickup
    ...
    CREATE_COLLECTABLE1 -1176.168823 -1318.154785 16.2  // A package
...
// Fail if exit the area
    IF NOT LOCATE_PLAYER_ANY_MEANS_3D player1 -1166.802124 -1304.314697 14.818102 25.0 25.0 25.0 FALSE
        selecting = 0
        allow_movement_after_cleanup = 1
        GOTO mission_cleanup
    ENDIF
